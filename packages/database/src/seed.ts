...
async function main() {
    ...
    const superAdmin = await prisma.user.create({
        data: {
            email: "superadmin@jengashop.com",
            username: "superadmin",
    ...
    const products = await Promise.all([
        prisma.product.create({
            data: {
                name: 'MacBook Pro 14"',
                description:
                    "Latest MacBook Pro with M2 chip, 16GB RAM, 512GB SSD",
                price: 2499.99,
        ...
        prisma.product.create({
            data: {
                name: "iPhone 15 Pro",
                description:
                    "Latest iPhone with A17 Pro chip, 128GB storage",
                price: 999.99,
                category: "Electronics",
                stock: 25,
                images: [
        ...
        prisma.product.create({
            data: {
                ...
                description:
                    "Classic Nike Air Max 90 sneakers in white/black colorway",
                price: 129.99,
                category: "Shoes",
                stock: 50,
                images: [
        ...
        prisma.product.create({
            data: {
                ...
                description:
                    "Samsung 55-inch 4K UHD Smart TV with HDR support",
                price: 699.99,
                category: "Electronics",
                stock: 8,
                images: [
        ...
        prisma.product.create({
            data: {
                ...
                description:
                    "Classic straight-leg jeans in indigo wash",
                price: 69.99,
                category: "Clothes",
                stock: 75,
                images: [
    ...
    console.log(
        `- Users: ${
            1 + 1 + users.length
        } (1 SUPERADMIN, 1 ADMIN, ${users.length} USER)`
    )
    ...
    console.log("\n🔐 Login Credentials:")
    console.log(
        "SUPERADMIN: superadmin@jengashop.com / admin123"
    )

...
async function main() {
    ...
    const products = await Promise.all([
        ...
        prisma.product.create({
            data: {
                ...
                description: "Multi-functional pressure cooker, slow cooker, rice cooker",
                price: 89.99,
                category: "Kitchen",
                stock: 30,
                images: [
    ...
    const supportMessages = await Promise.all([
        prisma.supportMessage.create({
            data: {
                ...
                message: "I need help with my recent order. The tracking shows it's shipped but I haven't received any updates.",
                isRead: false
            }
        }),
        prisma.supportMessage.create({
        ...
        prisma.supportMessage.create({
            data: {
                ...
                message: "I would like to cancel my order ORD-2024-003. Please let me know the process.",
                isRead: false
            }
        })
    ]);
    ...
    console.log("\n📊 Summary:");
    console.log(`- Users: ${1 + 1 + users.length} (1 SUPERADMIN, 1 ADMIN, ${users.length} USER)`);
